...
driver.get('https://leetcode.com/problems/invert-binary-tree/')
...
#content = driver.find_element(By.CLASS_NAME, 'view-line')
# id of dropdown menu leetcode = "headlessui-listbox-button-:r29:"
# class of code editor lines = "view-line"
